...
const PartsFinder = () => {
  ...
  return (
    <div className="w-full h-auto bg-gradient-to-br from-red-400 via-red-500 to-red-600">
      <div className="lg:px-[120px] px-6 py-2 lg:py-4">
        <div className="items-center text-center mb-0">
          <div className="w-full my-2 lg:my-4">
            <h1 className="text-2xl md:text-3xl lg:text-4xl text-center font-bold text-white mb-6 leading-tight">
              Expert car service & repair in Abu Dhabi, UAE
            </h1>
